...
etiqueta: "NUEVO",
        desc: "<b>REF002</b> <p>Disfruta de acceso completo a las funciones avanzadas de Inteligencia Artificial con una cuenta lista para usar durante 30 días completos. Potencia tu productividad, crea contenido, analiza datos y accede a los modelos más rápidos y actualizados sin interrupciones.<p><b> </b><p>",
...
etiqueta: "¡NUEVO!",
        ...
        caracteristicas: ["Activación en hasta 5 dispositivos.", "Vitalicia.", "Compatible con PC / Android / iOS.", "100 GB de almacenamiento.", "IA vía web para mayor productividad", "Tendras acceso a PowerBI Service."],
...
etiqueta: "NUEVO",
        ...
        caracteristicas: ["Acceso a Gemini Pro.", "Modelos de IA avanzados para mayor rendimiento.", "Ayuda en redacción, programación, estudio y productividad.", "Generación de contenido y asistencia inteligente.", "Beneficios adicionales incluidos con la promoción de Jio 5TB de espacio.", "Disponible desde navegador web, Android y dispositivos compatibles con los servicios de Google.", "Se entrega un link listo para canjear. Solo deberás abrir el enlace y seguir las instrucciones para activar tu beneficio."],
