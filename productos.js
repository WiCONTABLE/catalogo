    ...
    },           
{
    ...
    },     
 {
        ...
        mostrarTecnica: true,
etiqueta: "ACTIVA",
        desc: "<b>REF005</b><p>Verifica de forma masiva, automática y directamente en el portal DIAN el nombre asociado a los NIT de contribuyente Persona Jurídica ó Persona Natural suscritos, sin procesos manuales ni captchas repetitivos.<p> <p>Ideal para temporada de exógena y validación de los formatos que requieran esta auditoría.<p><b>Publicada el 05-01-2026</b>",
        caracteristicas: ["Carga un archivo EXCEL ó pega directamente los Nits (Sin punto ni comas).", "Puedes decidir en consultar CON estado RUT, la cual te anexara si esta: ACTIVO, CANCELADO ó SUSPENDIDO; este proceso valida catpcha y depende si el portal web se encuentre estable.", "Puedes decidir en consultar SIN estado RUT, la cual es más ligero y estable; este proceso solo te indica si está registrado o no en la DIAN mediante el módulo inconsisitencias RUT."],
...
etiqueta: "DISPONIBLE",
        ...
        caracteristicas: ["Acceso a Gemini Pro", "Modelos de IA avanzados para mayor rendimiento (Chat / Spark).", "Ayuda en redacción, programación, estudio y productividad.", "Generación de contenido y asistencia inteligente.", "Beneficios adicionales incluidos con la promoción de Jio 5TB de espacio.", "Se entrega un link vía anydesk listo para canjear el beneficio." ,"Disponible desde navegador web, Android y dispositivos compatibles con los servicios de Google."],
        nota: "Te en cuenta las siguientes recomendaciones: <b>El enlace es de un solo uso.</b> Se recomienda canjearlo únicamente en la cuenta de Google donde deseas disfrutar el beneficio; Una vez activado correctamente, el servicio quedará asociado a tu cuenta Gmail. <p><b>Te realizamos acompañamiento vía Anydesk, para ello tenerlo instalado para poder proceder y para validar una correcta activación, es importante que estes en un PC, no es válido ni en Tablet, ni celular para el acompañamiento.</b></p> <p>Manejamos pago local COP y Binance USDT.</p> <p><b>Tener en cuenta que se brinda garantía por 3 meses y que solo se procede si podemos asistir vía anydesk, de lo contrario no hay garantía.</b> Precio en USDT $10 mediante Binance.<p/>",
        precio: "COP $30.000",
...
etiqueta: "DISPONIBLE",
        ...
        caracteristicas: ["Vea y controle la pantalla de otro dispositivo.", "No requiere licencia y puedes usarlo incluso si formateas tu PC en el futuro."],
...
etiqueta: "DISPONIBLE",
        ...
        nota: "Se entrega la clave al usuario final, quien es responsable de su buen uso. La clave permanece operativa de manera indefinida, garantizando acceso continuo y seguridad en todo momento. <b>único pago.</b> se brinda apoyo para la instalación de manera remota mediante AnyDesk. Precio en USDT $7 mediante Binance.",
        precio: "COP $20.000",
        video: "",
    ...
    },
{
        ...
        url: "spotify3meses.html",
        formato: "Credenciales",
        mostrarTecnica: true,
        etiqueta: "DISPONIBLE",
        desc: "<p>Recibe una cuenta Premium lista para usar, con su respectivo correo y contraseña.</p><p>¿Ya tienes una cuenta gratuita con tus playlists favoritas? ¡No las pierdes! Comparte el enlace de tus listas con la cuenta Premium, guárdalas allí y disfruta durante 3 meses premium; (Tú puedes luego cambiar la contraseña del correo).</p>",
        ...
        nota: "<b><p>RECUERDE</b> que es importante ver el videotutorial antes de adquirir la credencial, de esta manera le será más fácil despejar dudas de funcionamiento.</p> <p>Las credenciales toman un tiempo 15 minutos para la entrega una vez hayas realizado el respectivo pago.</p>",
        precio: "COP $5.000",
...
etiqueta: "AGOTADO",
        ...
        nota: "El valor del servicio puede variar según la complejidad de la realidad financiera del contribuyente (cantidad de cruce cedular, inversiones, etc.). <b>¡Contáctanos para una cotización personalizada!</b>",
