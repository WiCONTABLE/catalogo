...
etiqueta: "DISPONIBLE",
        ...
        nota: "Te encuenta las siguientes recomendaciones: <b>El enlace es de un solo uso.</b> Se recomienda canjearlo únicamente en la cuenta de Google donde deseas disfrutar el beneficio; Una vez activado correctamente, el servicio quedará asociado a tu cuenta gmail. <b>Te realizamos acompañamiento vía Anydesk, para ello tenerlo instalado para poder proceder y para validar una correcta activación, es importante que estes en un PC, no es valido ni en Tablet, ni celular para el acompañamiento.</b> Aplica solo para cliente que puedan realizar el pago con plataformas Colombia. <b>Tener en cuenta que se brinda garantia por 3 meses y que solo se procede si podemos asistir la activación, de esta manera se garantiza una correcta activación.</b>",
        precio: "COP $30.000",
