...
etiqueta: "¡EN PRODUCCION!",
        ...
        caracteristicas: ["<b>Cero trámites adicionales:</b> <p>No necesitas generar Token ni adquirir un Certificado Digital de la DIAN para descargar tus PDFs.</p>","<b>Módulo Descarga PRO (Multidocumento):</b> Carga tu plantilla de Excel con los códigos (CUDE, CUDS, CUFE, CUNE) y su respectivo NIT. El sistema procesa de forma automatizada (entre 3 y 9 segundos por documento) eludiendo los captchas y entregando los PDFs listos para visualizar, sin contraseñas.", "<b>Módulo Descarga F.E. (Ultrarrápido):</b> Descarga masiva de Facturas Electrónicas y Notas a una velocidad increíble de 0.5 segundos por documento. Sin captchas, sin NIT y sin contraseñas. Solo carga tu Excel o pega los CUFES directamente.", "<b>Módulo Tools (Gestión y Exportación):</b> Toma el control total de tus archivos. Renombra tus PDFs de forma masiva, extrae la información clave, lístala y expórtala directamente a Excel para tus cruces e informes.<p>"],
