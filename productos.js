...
etiqueta: "¡NUEVO!",
        ...
        caracteristicas: ["<p><b>Conversión avanzada a Excel:</b> Es su función más destacada. Permite seleccionar tablas manualmente o usar detección automática para exportar datos limpios a .xlsx o .csv, ajustando filas, columnas y delimitadores antes de convertir.</p>","<p><b>Múltiples formatos de salida:</b> Convierte archivos PDF a Word, PowerPoint, AutoCAD (DWG/DXF), HTML, imágenes y texto plano.", "<p><b>Motor OCR integrado:</b> Reconoce y extrae texto o tablas desde documentos escaneados o imágenes fotográficas en varios idiomas." , "<p><b>Procesamiento por lotes (Batch):</b> Permite convertir carpetas enteras de archivos PDF de manera simultánea sin intervención manual paso a paso.", "<p><b>Edición y seguridad:</b> Incluye herramientas para modificar texto directamente en el PDF, agregar páginas, crear formularios interactivos, añadir firmas digitales y cifrar con contraseñas.</p>"],
